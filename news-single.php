                    ...
                    <div class="row justify-content-center align-items-center">
                        <div class="col-lg-8">
                            <h1 class="text-start fs-48 fs-sm-10vw wow fadeIn" data-wow-delay=".6s">
                                Global Design Minds to Converge at 2026 Design Expo Conference
                            </h1>
                    ...
                    <div class="col-lg-10">
                        <div class="blog-read">
                            ...
                            <div class="post-text">
                                ...
                                <p>The 2026 Design Expo Conference is set to become the epicenter of global design innovation, as top creatives, technologists, and thought leaders gather to explore the future of design across industries. Scheduled for October 1â€“5, 2026 in San Francisco, the event promises to showcase cutting-edge design practices, technological integrations, and visionary ideas that are shaping the next generation of user experience, product development, and visual storytelling.</p>

                                <p>Bringing together architects, UX/UI designers, product innovators, AI enthusiasts, and creative directors from over 50 countries, the conference serves as a collaborative platform to exchange knowledge, trends, and tools transforming the design ecosystem. Key themes for this year include AI-driven creativity, sustainability in design, spatial computing, and inclusive design methodologies.</p>

                                <h5>Highlights of the 2026 Design Expo include:</h5>
                                ...
                                <p>In addition to in-person attendance, the event will feature a hybrid format with virtual access to all keynotes and live panels, allowing participants from around the world to engage and collaborate.</p>

                                <p>Whether you're a seasoned professional or a rising designer, the 2026 Design Expo Conference is the ultimate opportunity to stay ahead of the curve and shape whatâ€™s next in the world of design.</p>
                        ...
                        <div id="blog-comment">
                            ...
                            <ol>
                                <li>
                                    <div class="avatar">
                                        <img src="images/testimonial/1.webp" class="w-70px" alt="" ></div>
                                    <div class="comment-info">
                                        <span class="c_name text-light">Merrill Rayos</span>
                                    ...
                                    <ol>
                                        <li>
                                            <div class="avatar">
                                                <img src="images/testimonial/2.webp" class="w-70px" alt="" ></div>
                                            <div class="comment-info">
                                                <span class="c_name text-light">Jackqueline Sprang</span>
                                                <span class="c_date id-color">2 days ago</span>
                                                <span class="c_reply"><a href="#">Reply</a></span>
                                                <div class="clearfix"></div>
                                            </div>
                                ...
                                <li>
                                    <div class="avatar">
                                        <img src="images/testimonial/3.webp" class="w-70px" alt="" ></div>
                                    <div class="comment-info">
                                        <span class="c_name text-light">Sanford Crowley</span>
                                        <span class="c_date id-color">2 days ago</span>
                                        <span class="c_reply"><a href="#">Reply</a></span>
                                        <div class="clearfix"></div>
                                    </div>
                                    ...
                                    <ol>
                                        <li>
                                            <div class="avatar">
                                                <img src="images/testimonial/4.webp" class="w-70px" alt="" ></div>
                                            <div class="comment-info">
                                                <span class="c_name text-light">Lyndon Pocekay</span>
                                                <span class="c_date id-color">2 days ago</span>
                                                <span class="c_reply"><a href="#">Reply</a></span>
                                                <div class="clearfix"></div>
                                            </div>
                                ...
                                <li>
                                    <div class="avatar">
                                        <img src="images/testimonial/5.webp" class="w-70px" alt="" ></div>
                                    <div class="comment-info">
                                        <span class="c_name text-light">Aleen Crigger</span>
                                        <span class="c_date id-color">2 days ago</span>
                                        <span class="c_reply"><a href="#">Reply</a></span>
                            ...
                            <div id="comment-form-wrapper">
                                ...
                                <div class="comment_form_holder">
                                    <form id="contact_form" name="form1" class="form-border" method="post" action="#">
                                        ...
                                        <textarea cols="10" rows="10" name="message" id="message" class="form-control mb-4"></textarea>
                                        <div id="error_message" class="error">Please check your message</div>
                                        <div id="mail_success" class="success">Thank you. Your message has been sent.</div>
                                        <div id="mail_failed" class="error">Error, email not sent</div>
                                        <a class="btn-main fx-slide" href="#"><span>Submit</span></a>
                                    </form>
                                </div>
                            </div>
                        </div>
